...
def analyze_unstructured_input(text: str) -> dict:
    ...
    if is_legal:
        ...
        personas["Legal Advisor"] = {
            ...
            "action_items": [
                ...
                "Audit timesheets and overtime logs",
    ...
    if is_health:
        ...
        personas["Clinical Practitioner"] = {
            ...
            "action_items": [
                "Schedule detailed medical history review",
                "Recommend symptom and activity logging",
                "Assess occupational stress factors",
            ],
        }
    if is_product:
        ...
        personas["Product Owner"] = {
            ...
            "action_items": [
                "Create A/B test for shipping cost placement",
                "Draft user stories for upfront pricing calculator",
                "Audit checkout funnel conversion rate",
            ],
        }
    if is_eng:
        ...
        personas["Software Architect"] = {
            ...
            "action_items": [
                "Trace API call latency",
                "Inspect system integration logs",
                "Review architectural dependency graph",
            ],
        }
    if is_gov:
        ...
        personas["Compliance Officer"] = {
            ...
            "action_items": [
                "Verify data lineage mappings in Marquez",
                "Run OPA compliance check",
                "Audit dependency SBOM via Dependency-Track",
            ],
        }
    ...
    if not detected_domains:
        ...
        personas["Executive Summary"] = {
            ...
            "action_items": [
                "Categorize input under operational goals",
                "Assign review tasks to agent council",
            ],
        }
...
def discover_opportunities_risks_anomalies(text: str) -> dict:
    ...
    return {"opportunities": opportunities, "risks": risks, "anomalies": anomalies}
