...
**Debt Summary Score:** 50 / 100

### Active TODOs and FIXMEs

| File | Line | Task / Details |
| :--- | :--- | :--- |
| uawos_proactive_governance.py | 93 | "if \"TODO\" in", |
| uawos_proactive_governance.py | 94 | "re.search(r\"(?:TODO|FIXME)", |
| uawos_proactive_governance.py | 100 | ]) or line_strip == "# TODO": |
...
| uawos_proactive_governance.py | 106 | `if any(s in line_strip for s in ["noqa", "type: ignore", "pylint: disable"]):` |
