...
if __name__ == "__main__":
    ...
    print("Checking Developer1 (Developer) on budget (should be False):", check_fga_authorization("Developer1", "Developer", "budget"))
    print("Checking Developer1 (Developer) on licensing (should be True):", check_fga_authorization("Developer1", "Developer", "licensing"))
    print("Checking Hacker (Hacker) on licensing (should be False):", check_fga_authorization("Hacker", "Hacker", "licensing"))
