...
def run():
    ...
    tuples = [
        {"user": "user:Alice", "relation": "member", "object": "role:CEO"},
        {"user": "role:CEO#member", "relation": "permitted", "object": "action_category:budget"},
    ]
    ...
    try:
        ...
        check_payload = {
            "tuple_key": {"user": "user:Alice", "relation": "permitted", "object": "action_category:budget"},
        ...
        check_payload_bob = {
            "tuple_key": {"user": "user:Bob", "relation": "permitted", "object": "action_category:budget"},
            "authorization_model_id": model_id,
        }
