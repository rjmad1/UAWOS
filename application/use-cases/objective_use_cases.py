# application/use-cases/objective_use_cases.py
import re
import time
...
def recalculate_scores(objective_id: str):
    ...
    # 1. Check circular dependency status
    ...
    # 4. Check measurable outcomes exist
    has_outcomes = True
    try:
    ...
    # Recalculate health and confidence using domain scoring functions
